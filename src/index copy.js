...
(function () {
  ...
  const domEntryButton = document.querySelector('.button_type_entry');
  ...
  //   ],
  //   regSubmitButton,
  //   // new BlockButton('или', 'Войти', 'button_type_entry'),
  //   'или',
  //   'Войти',
  //   'button_type_entry',
  ...
  // const buttonRegistrationHint = new BlockButton('или ', 'Зарегистрироваться', 'button_type_registration');
